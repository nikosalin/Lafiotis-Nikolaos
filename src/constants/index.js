...
export const HERO_CONTENT = `I am a passionate full stack junior developer with a knack for crafting web applications. With 2 years of hands-on experience, I have honed my skills in front-end technologies like React and Typescript, as well as back-end technologies like Node.js, PostgreSQL, and MongoDB. I also have some experience on optical fiber as an object manager as well`;

export const ABOUT_TEXT = `I am a dedicated junior full stack developer with a passion for creating web applications. Since 2018 when I first started my coding courses through university, I have worked with a variety of technologies, including React, Next.js, Node.js, Java, Typescript, PostgreSQL, Firebase and MongoDB. My journey in web development began in university, and it has evolved into a lifetime passion where I continuously try to learn new things. Outside of coding, I have good Project Managment knowledge on optical fiber.`;
